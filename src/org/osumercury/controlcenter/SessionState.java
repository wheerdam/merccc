...
public class SessionState {
    ...
    private ArrayList<Score> activeScoreList;
    private ArrayList<Callback> advanceHooks;
    ...
    public synchronized void advance() {
        if(runs > maxAttempts) {
            System.err.print("SessionState: extra call to advancePhase");
            System.err.println(" - attempts: " + runs);
            return;
        } else if(runs == 0) {
            startTimer(); // start timer for RUN window
        }
